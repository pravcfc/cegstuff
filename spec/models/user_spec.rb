...
describe User do
  ...
  before do  
  	@user = User.new(name: "Stephen Elop", email: "user@example.com", password: "foobar", password_confirmation: "foobar") 
	end
  ...
  it { should respond_to(:password_digest) }i l
...
describe "with a password that's too short" do
  ...
  describe "return value of authenticate method" do
   ...
   # describe "with invalid password" do       //not working so removed for the moment
